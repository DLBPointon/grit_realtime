...
dl_dict = {
    ...
    'iu': 'Psocodea', 'iv': 'Strepsiptera', 'iy': 'Hymenoptera', 'iz': 'Zygentoma',
    'ja': 'Anthozoa', 'jh': 'Hydrozoa', 'jn': 'Nuda', 'jr': 'Staurozoa', 'js': 'Scyphozoa', 'jt': 'Tentaculata', 'jm': 'Myxozoa',
    'ka': 'Ascidiacea', 'kc': 'Cephalaspidomorphi', 'kd': 'Appendicularia', 'ke': 'Enteropneusta', 'kl': 'Leptocardii',
    ...
    'qq': 'Arachnida', 'qs': 'Symphyla', 'qu': 'unspecified_class_Arthropoda', 'qx': 'Maxillopoda', 'qy': 'Pycnogonida', 'ql': 'Collembola',
    ...
    'wk': 'Arhynchobdellida', 'wl': 'Lumbriculida', 'wn': 'Enchytraeida', 'wo': 'Opisthopora', 'wp': 'Phyllodocida', 'wf': 'Flabelligerida',
    'wr': 'Rhynchobdellida', 'ws': 'Sabellida', 'wt': 'Terebellida', 'wu': 'unspecified_order_Polychaeta', 'wg': 'Golfingiida',
